...
import { Github, Linkedin, Mail, Phone, Download, ArrowRight, Sparkles, Award, Menu, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div 
          className="absolute w-64 h-64 md:w-96 md:h-96 bg-gray-100 rounded-full blur-3xl opacity-60"
          style={{
            top: '10%',
            left: '5%',
        ...
        />
        <div 
          className="absolute w-64 h-64 md:w-96 md:h-96 bg-gray-50 rounded-full blur-3xl opacity-60"
          style={{
            bottom: '10%',
            right: '5%',
      ...
      <section id="about" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gray-50 relative">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-light text-black mb-8 sm:mb-12 text-center fade-in-section">About Me</h2>
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed fade-in-section">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 sm:mt-12 fade-in-section">
      ...
      <section id="projects" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 relative">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-light text-black mb-8 sm:mb-12 text-center fade-in-section">Featured Projects</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {projects.map((project, idx) => (
              <Card key={idx} className="border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group fade-in-section bg-white" style={{ animationDelay: `${idx * 0.1}s` }}>
                <CardHeader>
      ...
      <section id="contact" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-light text-black mb-6 sm:mb-8 fade-in-section">Get In Touch</h2>
          <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-12 max-w-2xl mx-auto fade-in-section">
            I'm always open to discussing new opportunities, collaborations, or just connecting with fellow tech enthusiasts.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 sm:mb-12 fade-in-section">
            ...
            <Button asChild variant="outline" size="lg" className="border-black text-black hover:bg-gray-50 w-full sm:w-auto transition-all hover:scale-105 hover:shadow-lg">
          ...
          <div className="flex items-center justify-center gap-6 fade-in-section">
            ...
            <a href={`tel:${personalInfo.phone}`} className="text-gray-600 hover:text-black transition-all hover:scale-110">
